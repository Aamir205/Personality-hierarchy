...
def get_fold_labels(part, dir, fold):
    ...
    label_idx = ["Q257_1",	"Q257_2",	"Q257_3",	"Q257_4",	"Q257_5",	"Q257_6",	"Q257_7",	"Q257_8",	"Q257_9",	"Q257_10", "Q257_11", "Q257_12", "Q257_13", "Q257_14", "Q257_15","Q257_16",	"Q257_17",	"Q257_18",	"Q257_19",	"Q257_20",	"Q257_21",	"Q257_22",	"Q257_23",	"Q257_24",	"Q257_25",	"Q257_26",	"Q257_27",	"Q257_28",	"Q257_29",	"Q257_30",	"Q257_31",	"Q257_32",	"Q257_33",	"Q257_34",	"Q257_35",	"Q257_36",	"Q257_37",	"Q257_38",	"Q257_39",	"Q257_40",	"Q257_41",	"Q257_42",	"Q257_43",	"Q257_44",	"Q257_45",	"Q257_46",	"Q257_47",	"Q257_48",	"Q257_49",	"Q257_50",	"Q257_51",	"Q257_52",	"Q257_53",	"Q257_54",	"Q257_55",	"Q257_56",	"Q257_57",	"Q257_58",	"Q257_59",	"Q257_60"]
    ...
    print("inside get fold labels NICEEEEEEEEEEEEEEEEEEEEEEEe")
    return p1, p2, l1
...
def get_labels(part, dir):
  ...
  print("Full columns in label file:", df3.columns.tolist())
  print("First row values:", df3.iloc[0].values)
  print("Selected labels:", df3.loc[df3["ID"].isin([p1,p2])][label_idx].values)
  print("inside get labels FUCKKKKKKKKKKKKKKKKKKKKKKKKk")
  return p1,p2, l1
...
def fused_data(fusion_strategy, batch_size, section, dyad=False, split="val", fold=-1):
    ...
    train_labels = np.zeros((1,60))
    
    test_file_list = np.zeros((1,4))
    test_labels =  np.zeros((1,60))

    val_file_list = np.zeros((1,4))
    val_labels =  np.zeros((1,60))
