...
for fold in folds:
    ...
    if modality in ["avg_decision", "decision", "feature","attention", "idv_decision"]:
        ...
        if modality in ["decision", "avg_decision"]:
            if args.dyad:
                au1=g1=p1=aud1=au2=g2=p2=aud2=ResNet50(15, channels=1)
                ...
                gaze_model = ResNet50(15, channels=1)
                pose_model = ResNet50(15, channels=1)
                au_model = ResNet50(15, channels=1)
        ...
        ## Feature-level fusion
            ...
            model = ResNet50(15, channels=1).to(device)
    else:
